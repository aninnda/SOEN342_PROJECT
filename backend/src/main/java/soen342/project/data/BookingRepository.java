...
public interface BookingRepository extends JpaRepository<Booking, Long> {
	...
	List<Booking> findByPassengerIdentifierAndPassengerNameContainingIgnoreCase(String passengerIdentifier, String passengerName);

	// convenience: find by identifier only
	List<Booking> findByPassengerIdentifier(String passengerIdentifier);
